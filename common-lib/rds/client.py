"""
Database client for connecting to RDS Aurora PostgreSQL database.
"""
...
class DatabaseClient:
    """Client for managing database connections to RDS Aurora PostgreSQL."""
    ...
    def __init__(self):
        ...
        self.db_name = os.getenv("DB_NAME", "ai-playground-db")
